# Phase 1: X25519 Diffie-Hellman key exchange demo.
#
# Alice and Bob exchange X25519 public keys, compute a shared secret, then run HKDF
# to get a usable symmetric key.
